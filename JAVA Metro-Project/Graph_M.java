...
import java.io.*;
	...
	public class Graph_M
	{
		public class Vertex
		{
			HashMap<String, Integer> nbrs = new HashMap<>();  //store the neighbors and their weights
		}

		// Map to store the vertices(stations)  of the graph
		...
		// Method to check if a vertex is present in the graph
